...
.method public static a(Landroid/content/Intent;)Lcn/jpush/android/api/CustomMessage;
    ...
    const-string v1, "processMessage failed:"
...
.method private static a(Landroid/content/Context;IJJ)V
    ...
    invoke-static {v0, p1, p2, p3}, Lcn/jpush/android/g/b;->a(IBJ)[B
...
.method public static a(Landroid/content/Context;Lcn/jpush/android/d/d;)V
    ...
    invoke-static {p0}, Lcn/jpush/android/f/b;->b(Landroid/content/Context;)Z
    ...
    :cond_7a
    invoke-static {p0, p1}, Lcn/jpush/android/f/b;->a(Landroid/content/Context;Lcn/jpush/android/d/d;)V

    :cond_7d
    return-void
.end method

.method public static a(Landroid/content/Context;Lcn/jpush/android/g/d;)V
    .registers 16

    invoke-virtual {p1}, Lcn/jpush/android/g/d;->b()I

    move-result v1

    invoke-virtual {p1}, Lcn/jpush/android/g/d;->g()J

    move-result-wide v2

    invoke-virtual {p1}, Lcn/jpush/android/g/d;->d()J
    ...
    invoke-virtual {p1}, Lcn/jpush/android/g/d;->h()Ljava/lang/String;
    ...
    if-eq v7, p1, :cond_105

    const/16 p1, 0x64

    if-eq v7, p1, :cond_10c
    ...
    invoke-static {p0, v8, p1, v2, v3}, Lcn/jpush/android/h/a;->a(Landroid/content/Context;Ljava/lang/String;IJ)J
    ...
    :try_end_117
    .catchall {:try_start_71 .. :try_end_117} :catchall_118
...
.method public static b(Landroid/content/Context;Lcn/jpush/android/d/d;)V
    ...
    invoke-static {v0, v3, p1, v2, p0}, Lcn/jpush/android/helper/g;->a(Ljava/lang/String;Ljava/lang/String;BILandroid/content/Context;)V
    ...
    :try_end_d6
    .catchall {:try_start_4 .. :try_end_d6} :catchall_d7
