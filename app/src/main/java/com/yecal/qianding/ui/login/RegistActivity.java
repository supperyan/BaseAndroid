...
import com.yecal.qianding.view.ClearableEditText;
...
//        });
    ...
    @OnClick({R.id.regist_get_code, R.id.regist_updata, R.id.regist_login, R.id.regist_tologin, R.id.regist_eye})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.regist_get_code:
                getCode();
                break;
            case R.id.regist_updata:
                goUpdataPassword();
                break;
            case R.id.regist_login:
                finish();
                break;
            case R.id.regist_tologin:
                finish();
                break;
