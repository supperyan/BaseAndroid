...
.method public run()V
    ...
    invoke-static {v2}, Lcn/jpush/android/j/a;->a(Landroid/webkit/WebSettings;)V

    invoke-static {v8}, Lcn/jpush/android/j/a;->a(Landroid/webkit/WebView;)V

    new-instance v10, Lcn/jpush/android/k/a/e;

    iget-object v3, p0, Lcn/jpush/android/api/SystemAlertHelper$1;->b:Landroid/content/Context;

    iget-object v4, p0, Lcn/jpush/android/api/SystemAlertHelper$1;->a:Lcn/jpush/android/d/d;
    ...
    invoke-direct/range {v2 .. v7}, Lcn/jpush/android/k/a/e;-><init>(Landroid/content/Context;Lcn/jpush/android/d/d;Landroid/view/WindowManager;Landroid/webkit/WebView;Landroid/widget/ImageButton;)V

    sput-object v10, Lcn/jpush/android/api/SystemAlertHelper;->a:Lcn/jpush/android/k/a/e;

    new-instance v2, Lcn/jpush/android/k/a/a;

    const-class v3, Lcn/jpush/android/k/a/b;

    const/4 v4, 0x0

    const-string v5, "JPushWeb"

    invoke-direct {v2, v5, v3, v4, v4}, Lcn/jpush/android/k/a/a;-><init>(Ljava/lang/String;Ljava/lang/Class;Landroid/widget/ProgressBar;Landroid/widget/TextView;)V
