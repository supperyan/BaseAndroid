...
.method private a(Lcn/jpush/android/d/d;)V
    .registers 5
    ...
    iget v1, p1, Lcn/jpush/android/d/d;->p:I
    ...
    invoke-static {p0, p1}, Lcn/jpush/android/f/b;->b(Landroid/content/Context;Lcn/jpush/android/d/d;)V
    ...
    :cond_34
    const-string p1, "Null message entity! Close PushActivity!"
...
.method static synthetic a(Lcn/jpush/android/ui/PushActivity;Lcn/jpush/android/d/d;)V
    .registers 2

    invoke-direct {p0, p1}, Lcn/jpush/android/ui/PushActivity;->b(Lcn/jpush/android/d/d;)V

    return-void
.end method

.method private b(Lcn/jpush/android/d/d;)V
    .registers 9
    ...
    :cond_12
    iget v1, p1, Lcn/jpush/android/d/d;->S:I

    if-nez v1, :cond_9c

    iget v1, p1, Lcn/jpush/android/d/d;->Q:I
    ...
    const-string p1, "Please add layout resource jpush_webview_layout.xml to res/layout !"
    ...
    invoke-static {v1}, Lcn/jpush/android/j/a;->a(Ljava/lang/String;)Z
    ...
    :cond_41
    iget-object v2, p1, Lcn/jpush/android/d/d;->P:Ljava/lang/String;

    iget-boolean v3, p1, Lcn/jpush/android/d/d;->q:Z
    ...
    const-string p1, "Please use default code in jpush_webview_layout.xml!"

    goto :goto_2e

    :cond_5c
    invoke-virtual {p0, v3}, Lcn/jpush/android/ui/PushActivity;->findViewById(I)Landroid/view/View;
    ...
    invoke-virtual {v0, p0, p1}, Lcn/jpush/android/ui/FullScreenView;->initModule(Landroid/content/Context;Lcn/jpush/android/d/d;)V
    ...
    :cond_9c
    iget p1, p1, Lcn/jpush/android/d/d;->R:I
...
.method private c()V
    ...
    invoke-direct {p0, v0}, Lcn/jpush/android/ui/PushActivity;->a(Landroid/content/Intent;)Lcn/jpush/android/d/d;
    ...
    iput-object v2, p0, Lcn/jpush/android/ui/PushActivity;->c:Ljava/lang/String;

    invoke-direct {p0, v0}, Lcn/jpush/android/ui/PushActivity;->a(Lcn/jpush/android/d/d;)V
...
.method public b()V
    ...
    iget v1, p0, Lcn/jpush/android/ui/PushActivity;->a:I
    ...
    invoke-virtual {p0, v1}, Lcn/jpush/android/ui/PushActivity;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {p0}, Lcn/jpush/android/j/a;->e(Landroid/content/Context;)V
    :try_end_70
